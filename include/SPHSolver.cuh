...
public:
    ...
    /**
     * @brief Initialize particle distribution as a solid cylinder (for turning/drilling)
     * @param center Start position of the cylinder axis
     * @param radius Radius of the cylinder
     * @param length Length of the cylinder along Z-axis (for turning, we can map to X or Y depending on orientation)
     ...
     * @param omega Angular velocity (rad/s) for setting tangential velocity
     */
    void rotateWorkpieceZ(double angle, double omega);
    
    // Legacy compatibility for TurningStrategy
