...
#include "GCodeInterpreter.h" // NEW
...
enum class NodeStatus { INACTIVE = 0, OK = 1, FAILED = 2 };
...
class Simulation {
public:
    // CHANGED: Constructor takes path argument
...
private:
    ...
    // NEW: G-Code Interpreter
    std::unique_ptr<GCodeInterpreter> m_gcode_interpreter;
