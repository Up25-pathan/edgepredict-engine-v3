...
/**
 * @brief Wear zone classification for tool
 */
enum class WearZone : int32_t {
    RAKE_FACE = 0,     // Chip contact (crater wear)
    FLANK_FACE = 1,    // Workpiece contact (flank wear)  
    CUTTING_EDGE = 2,  // Intersection (edge rounding)
    NONE = 3
};
