...
void Config::parseJson(const json& j) {
    ...
    if (machType == "turning") m_machining.type = MachiningType::TURNING;
    else if (machType == "milling") m_machining.type = MachiningType::MILLING;
    else if (machType == "drilling") m_machining.type = MachiningType::DRILLING;
    else if (machType == "grinding") m_machining.type = MachiningType::GRINDING;
