...
void MillingStrategy::applyKinematics(double dt) {
    // In milling: tool rotates, workpiece typically moves for feed
    ...
    // Move workpiece in feed direction (or equivalently, move tool opposite)
    // For simplicity, we keep workpiece stationary and move simulation frame
    
    // Update tool position for feed
